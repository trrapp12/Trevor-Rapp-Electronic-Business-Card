...
const Footer = (props) => {
  const iconsObjectArray = [
    {
      class: 'lni lni-html5',
      url: 'https://trrapp12.github.io/QUADRA-STALKR/',
    },
    {
      class: 'lni lni-css3',
    ...
    {
      class: 'lni lni-adobe',
      url: 'https://trrapp.myportfolio.com',
    },
  ];
    ...
    return (
      <button
        ...
        <a
          ...
          <i
            key={iKey}
            className={input.class}></i>
        </a>
      </button>
    );
  });

  return <div className='footer--container'>{iconsArrayOutput}</div>;
};
